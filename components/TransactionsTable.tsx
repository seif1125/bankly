...
const TransactionsTable = ({ account, transactions , isMainPage}: TransactionTableProps) => {
  console.log(transactions,account ,'transactionssassd');
  ...
  console.log('account',account.accountId,'transactions',transactions.length,'filteredTransactions',filteredTransactions.length);
