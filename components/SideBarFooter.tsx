  ...
  return (
    <footer className='footer'>
      <div className={type === 'desktop' ? 'footer_name' : 'footer_name-mobile'}>
        <p className='font-bold text-xl text-gray-700'>{getInitials(user.name)}</p>
      </div>
      <div  className={type === 'desktop' ? 'footer_email' : 'footer_email-mobile'}>
     <h1 className='text-[14px] truncate font-semibold capitalize text-gray-600'>{user.name}</h1>
